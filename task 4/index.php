...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        if (in_array($extension, $allowedExt)) {
            ...
            if (!move_uploaded_file($temp, $finalPath)) {
                array_push($errors,  'Error in uploading image please try again');
            }
        } else {
            array_push($errors, 'Invalid Extension');
        }
    } else {
    ...
    $file = fopen("RegisterData.txt", "a")  or die("unable to open file");
